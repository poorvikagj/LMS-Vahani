...
3. Copy the connection string and keep it for Railway as DATABASE_URL.
...
3. If CORS errors appear:
   - Verify CLIENT_URL_PROD and CLIENT_URL in Railway exactly match your Vercel URL.
   - Redeploy backend.
...
- Check DATABASE_URL value in Railway.
